...
public class DockerPush20Test extends AbstractBoostTest {
    ...
    private static String imageName = "localhost:5000/test-docker20:latest"
    ...
    public void testPushDockerImageToLocalRegistry() throws Exception {
        ...
        dockerClient.pullImageCmd("localhost:5000/test-docker20").withTag("latest").exec(new PullImageResultCallback())
